...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        if(Auth::user()->role->name == "Driver"){
            $pending = Order::where('status','=','pending')->where(['driver_id' => Auth::user()->id])->get();
            $processing = Order::where('status','=','processing')->where(['driver_id' => Auth::user()->id])->get();
            $completed = Order::where('status','=','completed')->where(['driver_id' => Auth::user()->id])->get();    
        }else{
