...
class GeneralSettingController extends Controller
{
    ...
    public function cms()
    {
        return view('admin.generalsetting.cms');
    }
    ...
    public function cms_update(Request $request)
    {
        ...
        if ($file = $request->file('home_fp_image'))
        {
            if(!empty($data->home_fp_image))
                if (file_exists('public/assets/images/home/'.$data->home_fp_image)) {
                unlink('public/assets/images/home/'.$data->home_fp_image);
            }

           $name = time().$file->getClientOriginalName();
           $file->move('public/assets/images/home',$name);
           $input['home_fp_image'] = $name;
        }

        if ($file = $request->file('home_sp_image'))
        {
            if(!empty($data->home_sp_image))
                if (file_exists('public/assets/images/home/'.$data->home_sp_image)) {
                unlink('public/assets/images/home/'.$data->home_sp_image);
            }

           $name = time().$file->getClientOriginalName();
           $file->move('public/assets/images/home',$name);
           $input['home_sp_image'] = $name;
        }

        if ($file = $request->file('home_tp_image'))
        {
            if(!empty($data->home_tp_image))
                if (file_exists('public/assets/images/home/'.$data->home_tp_image)) {
                unlink('public/assets/images/home/'.$data->home_tp_image);
            }

           $name = time().$file->getClientOriginalName();
           $file->move('public/assets/images/home',$name);
           $input['home_tp_image'] = $name;
        }
    ...
    public function tax(){
        ...
        return view ('admin.generalsetting.tax',compact('gs'));
    }
