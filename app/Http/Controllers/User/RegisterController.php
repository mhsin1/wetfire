	   ...
	   $request->merge([
        ...
        //--- Validation Section Ends
			...
			if($gs->is_verification_email == 1){
				...
				$msg = "Dear Customer,<br> We noticed that you need to verify your email address. <a href=".url('user/register/verify/'.$token).">Simply click here to verify.</a> <br> Or copy the following code to verify your account <br><strong>$code</strong>";
