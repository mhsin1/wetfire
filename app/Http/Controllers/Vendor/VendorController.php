...
class VendorController extends Controller
{
    ...
    public function profileupdate(Request $request)
    {
        ...
        $rules = [
               ...
               'shop_name'  => 'unique:users,shop_name,'.$data->id,
                ];
        ...
        {      
            ...
            $destinationPath = "assets/images/vendorbanner/".$data->shop_logo;
    ...
    public function verifysubmit(Request $request)
    {
        ...
        //--- Redirect Section        
        $msg = '<div class="text-center"><i class="fas fa-check-circle fa-4x"></i><br><h3>Your Documents Submitted Successfully.</h3></div>';
        return response()->json($msg);      
        //--- Redirect Section Ends     
    }
