            ...
            <div class="body-area">
              ...
              <form id="geniusformdata" action="{{route('admin-attr-store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col-lg-7 offset-lg-4">
                    <div class="custom-control custom-checkbox">
                      <input type="checkbox" id="quantityStatus1" name="quantity_status" class="custom-control-input" checked value="1">
                ...
                <div class="row">
                  <div class="col-lg-7 offset-lg-4">
                    <div class="custom-control custom-checkbox">
                      <input type="checkbox" id="imageStatus1" name="image_status" class="custom-control-input" checked value="1">
