                ...
                <div class="col-md-6 offset-md-3">
                  ...
                  <form id="geniusform" action="{{route('admin-attr-update', $attr->id)}}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row mt-1">
                        <div class="col-lg-12">
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" id="quantityStatus1" name="quantity_status" class="custom-control-input" {{ $attr->quantity_status == 1 ? 'checked' : '' }} value="1">
                            <label class="custom-control-label" for="quantityStatus1">Allow Quantity Field</label>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row mt-1">
                        <div class="col-lg-12">
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" id="imageStatus1" name="image_status" class="custom-control-input" {{ $attr->image_status == 1 ? 'checked' : '' }} value="1">
                            <label class="custom-control-label" for="imageStatus1">Allow Image Field</label>
                          </div>
                        </div>
                      </div>
