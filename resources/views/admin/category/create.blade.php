                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-cat-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="number" class="input-field" name="sequence" placeholder="{{ __('Enter Sequence') }}" required="" value="">
                          </div>
                        </div>
                                ...
                                <div id="image-preview" class="img-preview" style="background: url({{ asset('assets/admin/images/upload.png') }});">
                                    ...
                                    <input type="file" name="photo" class="img-upload" id="image-upload">
							              ...
							              <div class="checkbox-wrapper">
							                <input type="checkbox" name="top_menu" class="checkclick" id="top_menu" value="1">
							                <label for="top_menu">{{ __('Top Header Menu') }}</label>
												...
												<div class="row">
													...
													<div class="col-lg-7">
							              <div class="checkbox-wrapper">
							                <input type="checkbox" name="home_category" class="checkclick" id="home_category" value="1">
