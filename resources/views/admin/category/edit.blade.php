                  ...
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-cat-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" id="catos" value="Category">
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Sequence') }} *</h4>
                                <p class="sub-heading">{{ __('(In English)') }}</p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                              <input type="text" class="input-field" name="sequence" placeholder="{{ __('Enter Sequence') }}" required="" value="{{$data->sequence}}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload">
                                <div id="image-preview" class="img-preview" style="background: url({{ $data->photo ? asset('public/assets/images/categories/'.$data->photo):asset('assets/images/noimage.png') }});">
                              ...
                              <div class="checkbox-wrapper">
                                <input type="checkbox" name="top_menu" class="checkclick" id="top_menu" value="1" {{ $data->top_menu != 0 ? "checked":"" }}>
                                <label for="top_menu">{{ __('Top Header Menu') }}</label>
                              </div>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
                              <div class="checkbox-wrapper">
                                <input type="checkbox" name="home_category" class="checkclick" id="home_category" value="1" {{ $data->home_category != 0 ? "checked":"" }}>
                                <label for="home_category">{{ __('Home Page Category Section') }}</label>
                              </div>
													</div>
												</div>
