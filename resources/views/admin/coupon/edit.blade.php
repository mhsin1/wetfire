                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-coupon-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row hidden">
                          ...
                          <div class="col-lg-3">
                            <input type="number" step="0.01" min="1" class="input-field less-width" name="price" placeholder="" required="" value="{{$data->price}}"><span></span>
                          </div>
                        </div>
                        ...
                        <div class="row hidden">
                          ...
                          <div class="col-lg-7">
                            <input type="number" min="1" class="input-field less-width" name="times" placeholder="{{ __('Enter Value') }}" value="{{$data->times}}"><span></span>
                          </div>
                        </div>
