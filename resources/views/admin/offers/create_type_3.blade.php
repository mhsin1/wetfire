                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-offer-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="name" placeholder="{{ __('Enter offer name') }}" required="" value="">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <select id="type" name="product_id" required="">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="number" class="input-field" name="quantity" placeholder="{{ __('Enter Product Quantity') }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="number" class="input-field" name="discount_q" placeholder="{{ __('Enter Discount Amount in %') }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="start_date" id="from" placeholder="{{ __('Select a date') }}" required="" readonly="readonly">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="end_date" id="to" placeholder="{{ __('Select a date') }}" required="" readonly="readonly">
                          </div>
                        </div>
