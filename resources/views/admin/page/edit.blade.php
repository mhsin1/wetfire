                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-page-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <select name="category" id="">
                                <option @if($data->category == 'information') selected @endif value="information">Information</option>
                                <option @if($data->category == 'customer_service') selected @endif value="customer_service">Customer Service</option>
                                <option @if($data->category == 'extras') selected @endif value="extras">Extras</option>
                            </select>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Template') }} *</h4>
                                <p class="sub-heading">{{ __('(In English)') }}</p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <select name="type" id="">
                                <option @if($data->type == 'general') selected @endif value="general">General</option>
                                <option @if($data->type == 'contact') selected @endif value="contact">Contact</option>
                            </select>
                          </div>
                        </div>
