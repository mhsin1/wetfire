							...
							<div class="body-area">
								...
								<div class="gocover"
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input type="text" class="input-field" placeholder="{{ __('Enter Product Sku') }}"
												name="sku" value="{{ str_random(3).substr(time(), 6,8).str_random(3) }}" required="">
									...
									<!-- <div class="row">
										<div class="col-lg-12">
											<div class="left-area">
												<h4 class="heading">{{ __('Sub Child Category') }}*</h4>
											</div>
										</div>
										<div class="col-lg-12">
											<select id="subchildcat" name="subchildcategory_id" disabled="">
												<option value="">{{ __('Select Sub Child Category') }}</option>
											</select>
										</div>
									</div> -->
									...
									<div id="subchildcatAttributes"></div>
			...
			<p class="text">
				{{ isset($langg->lang805) ? $langg->lang805 : 'Prefered Size: (800x800) or Square Size.' }}
									...
									<!-- <div class="row">
										...
										<div class="col-lg-12">
											<input name="vat" step="0.1" type="number" value="5" class="input-field"
									...
									<div class="row">
										...
										<div class="row">
												...
												<div class="col-lg-12">
													<input name="dsc" type="number" value="0" min="0" max="10" class="input-field"
