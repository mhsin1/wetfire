...
@section('content')
     ...
     <div class="row">
         ...
         <div class="col-lg-8">
            <div class="row {{ $catAttribute->price_status == 0 ? 'd-none' : '' }}">
                 <div class="col-2">
                        +
                 </div>
                 <div class="col-10">
            ...
            <div class="row {{ $catAttribute->quantity_status == 0 ? 'd-none' : '' }}">
                 <div class="col-2">
                        &nbsp;
                 </div>
                 <div class="col-10">
                    <div class="quantity-container">
                         <input type="text" class="input-field quantity-input" id="{{ $catAttribute->input_name }}{{$option->id}}_quantity" data-name="{{ $catAttribute->input_name }}_quantity[]" placeholder="Quantity" value="{{ !empty($selectedAttrs["$inName"]['quantities'][$i]) && $checked == 1 ? $selectedAttrs["$inName"]['quantities'][$i] : '' }}">
                    </div>
             	</div>
         	</div>
            
            <div class="row {{ $catAttribute->image_status == 0 ? 'd-none' : '' }}">
                 <div class="col-2">
                 	<?php
					if(!empty($selectedAttrs["$inName"]['images'][$i]))
					{
						?>
                        <img style="width:50px; height:50px;" src="{{ asset('public/assets/images/products/'.$selectedAttrs["$inName"]['images'][$i]) }}" />
                        &nbsp;
                        <?php
					}
					else
                 ...
                 <div class="col-10">
                 	<div class="image-container">
                         <input type="file" class="input-field image-input" id="{{ $catAttribute->input_name }}{{$option->id}}_image" data-name="{{ $catAttribute->input_name }}_image[]" data-custom="{{ $catAttribute->input_name }}_custom[]">
                 	</div>
             	</div>
         	</div>
									...
									<h4 class="heading">{{ __('Shipping Charges') }}*</h4>
									@foreach($shippings as $key=> $shipping)
									<div class="row">
										<div class="col-lg-12">
											<div class="left-area">
												<h4 class="heading">{{ $shipping->title }}*</h4>
												<p class="sub-heading">{{ __('(Enter Delivery Charges for ') }} {{ $shipping->title }}{{ __(')') }}</p>
											</div>
										</div>
										<div class="col-lg-12">
											@php 
											$shipu = "";
											if($data->shipping)
											$shipu = explode(',',$data->shipping) @endphp
											<input name="shipping[]" type="text" class="input-field"
												placeholder="{{ __('e.g 20') }}" value="@if(isset($shipu[$key])){{ $shipu[$key]}} @else 0 @endif" required />
										</div>
									</div>
									@endforeach
										...
										<div class="product-description">
											<div class="body-area">
												...
												<!-- <div class="row">
													<div class="col-lg-12">
														<div class="left-area">
															<h4 class="heading">Vat Percentage*</h4>
														</div>
													</div>
													<div class="col-lg-12">
														<input name="vat" step="0.1" type="number" value="{{$data->vat}}" class="input-field"
															placeholder="Enter Vat%" min="0">
													</div>
												</div> -->
												...
												<div class="row">
													...
													<div class="row">
															<div class="col-lg-12">
																<div class="left-area">
																	<h4 class="heading">Dscount Percentage*</h4>
																</div>
															</div>
															<div class="col-lg-12">
																<input name="dsc" type="number" value="{{$data->dsc}}" min="0" max="10" class="input-field"
												...
												<!-- <div class="row">
						                            ...
						                            <div class="checkbox-wrapper">
						                              <input type="checkbox" name="seo_check" value="1" class="checkclick" id="allowProductSEO" {{ ($data->meta_tag != null || strip_tags($data->meta_description) != null) ? 'checked':'' }}>
						                              <label for="allowProductSEO">{{ __('Allow Product SEOs') }}</label>
						                            </div>
													</div>
												</div> -->
