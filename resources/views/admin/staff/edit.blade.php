                        ...
                        @include('includes.admin.form-error') 
											<form id="geniusformdata" action="{{ route('admin-staff-update',$data->id) }}" method="POST" enctype="multipart/form-data">
												{{csrf_field()}}
						                          ...
						                          <div class="col-lg-12">
						                            <div class="left-area">
						                                <h4 class="heading text-left">{{ __('Staff Profile Image') }} *</h4>
						                            </div>
						                          </div>
						                          <div class="col-lg-12">
						                            <div class="img-upload">
						                                <div id="image-preview" class="img-preview" style="background-size:contain;background: url({{ $data->photo ? asset('public/assets/images/admins/'.$data->photo) : asset('public/assets/images/noimage.png') }});">
