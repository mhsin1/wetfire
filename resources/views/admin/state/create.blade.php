                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-state-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="state_name" placeholder="{{ __('Enter State Name') }}" required="" value="">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="state_code" placeholder="{{ __('Enter State Code') }}" required="" value="">
                          </div>
                        </div>
