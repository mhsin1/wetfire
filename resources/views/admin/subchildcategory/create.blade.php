                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-subchildcat-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <select id="childcat" name="childcategory_id" required="" disabled=""></select>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="sequence" placeholder="{{ __('Enter Sequence') }}" required="" value="">
                          </div>
                        </div>
