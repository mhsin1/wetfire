...
@section('content')
                    ...
                    <div class="content-area">
                        <div class="mr-breadcrumb">
                            <div class="row">
                                <div class="col-lg-12">
                                        <h4 class="heading">{{ __("Customer Details") }} <a class="add-btn" href="javascript:history.back();"><i class="fas fa-arrow-left"></i> {{ __("Back") }}</a></h4>
                                        <ul class="links">
                                            <li>
                                            ...
                                            <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="user-image">
                                                            ...
                                                            <img src="{{ $data->photo ? asset($data->photo):asset('public/assets/images/'.$gs->user_image)}}" alt="No Image">
                                                            @else
                                                            <img src="{{ $data->photo ? asset('public/assets/images/users/'.$data->photo):asset('public/assets/images/'.$gs->user_image)}}" alt="No Image">                                            
                                                            @endif
