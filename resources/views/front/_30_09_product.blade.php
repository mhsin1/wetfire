    ...
    <div class="row">
        <div id="content" class="col-sm-12">
            <div class="row">
                <div class="col-sm-4">
                    <ul class="thumbnails">
                        <li><a class="thumbnail fancybox" href="{{asset('public/assets/images/products/'.$productt->photo)}}" title="iPod Classic"><img src="{{asset('public/assets/images/products/'.$productt->photo)}}" title="iPod Classic" alt="iPod Classic" /></a></li>
                        <div id="product-thumbnail" class="owl-carousel">
                            @foreach($productt->galleries as $gal)
                            <div class="item">
                                <li class="image-additional">
                                    <a class="thumbnail fancybox" rel="gallery1"  href="{{asset('public/assets/images/galleries/'.$gal->photo)}}" title="iPod Classic"> 
                                    <img src="{{asset('public/assets/images/galleries/'.$gal->photo)}}" title="iPod Classic" alt="iPod Classic" />
                                    </a>
                                </li>
                            </div>
                            @endforeach
                ...
                <div class="col-sm-7 ml-3">
                    ...
                    <ul class="list-unstyled product_info">
                        <li>
                            ...
                            <span> <a href="#">{{ $productt->category->name }}</a></span></li>
                        <li>
                            <label>Product Code:</label>
                            <span> product {{ $productt->id}}</span></li>
