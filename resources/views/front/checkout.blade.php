                                ...
                                <div id="ship-box-info">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="country-select clearfix mb-30">
                                                <label>Country <span class="required">*</span></label>
												<select id="shipping_cun" class="wide" name="shipping_country" >
													@include('includes.countries')
												</select>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-12" style="margin-top: 15px;">
                                <div class="">
                                    <ul style="display: flex;float: right;list-style: none;text-align: center;">
                                        <li style="margin-right: 10px;" class="mastero">
                                            <a href="#">
                                                <img alt="payment_mastero" src="{{ url('public/assets/front/image/payment/mastero.jpg') }}">
                                            </a>
                                        </li>
                                        <li style="margin-right: 10px;" class="visa">
                                            <a href="#">
                                                <img alt="payment_visa" src="{{ url('public/assets/front/image/payment/visa.jpg') }}">
                                            </a>
                                        </li>
                                        <li style="margin-right: 10px;" class="currus">
                                            <a href="#">
                                                <img alt="payment_currus" src="{{ url('public/assets/front/image/payment/currus.jpg') }}">
                                            </a>
                                        </li>
                                        <li style="margin-right: 10px;" class="discover">
                                            <a href="#">
                                                <img alt="payment_discover" src="{{ url('public/assets/front/image/payment/discover.jpg') }}">
                                            </a>
                                        </li>
                                    </ul>
                                </div>
