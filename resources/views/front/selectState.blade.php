    ...
    <div class="select-country-page d-flex align-items-center justify-content-center flex-column">
        <div class="select-country-inner border rounded-circle">
            <div class="w-100 h-100 d-flex flex-column align-items-center justify-content-center">
                ...
                <h5 class="text-capitalize">Kindly select your state</h5>
                <div class="w-75 w-sm-100 mt-5">
                    <div class="col-md-12 d-flex flex-column justify-content-center">
                        <div class="d-flex flex-row flex-wrap">
                            ...
                            @if($i < 6)
                            <div class="col-4 col-md-4 pl-3 pr-3 d-flex flex-column border-secondary">
                                <a href="{{ route('front.state' , $state->id) }}" class="btn btn-block mt-4" target="_self">{{ str_limit($state->state_name , 15)}}</a>
                            </div>
                    ...
                    <div class="col-md-4 mt-3">
                        <div class="row">
                            <div class="col-md-12 normal">
                                <a href="{{ route('front.state' , $state->id) }}"><button class="mt-2 btn btn-block btn-danger">{{ $state->state_name }}</button></a>
                            </div>
                        </div>
                    </div>
                @endforeach
