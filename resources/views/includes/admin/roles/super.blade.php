<li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-prod-deactive') }}"><span>{{ __('Deactivated Products') }}</span></a>
            </li>
            <li>
    ...
    <li>
        <a href="#country" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="icofont-ui-user-group"></i>{{ __('Countries') }}
        </a>
        <ul class="collapse list-unstyled" id="country" data-parent="#accordion">
            <li>
                <a href="{{ route('admin-country-index') }}"><span>{{ __('Countries') }}</span></a>
            </li>
            <!-- <li>
                <a href="{{ route('admin-state-index') }}"><span>{{ __('State') }}</span></a>
            </li>
            <li>
    ...
    <li>
        <a href="#return" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="icofont-double-left"></i>{{ __('Returns') }}
        </a>
        <ul class="collapse list-unstyled" id="return" data-parent="#accordion">
            <li>
                <a href="{{ route('admin-return_order-index') }}"><span>{{ __('Return Orders') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-reason-index') }}"><span>{{ __('Reasons') }}</span></a>
            </li>
            <!-- <li>
                <a href="{{ route('admin-vendor-withdraw-index') }}"><span>{{ __('Withdraws') }}</span></a>
            </li> -->
    ...
    <li><a href="{{route('admin-currency-index')}}"><i class="fas fa-dollar-sign"></i>{{ __('Currencies') }}</a></li>
    <!-- <li><a href="{{route('admin-offer-index')}}"><i class="fas fa-file"></i>{{ __('Offers') }}</a></li> -->
    ...
    <li>
        ...
        @endif" id="menu5" data-parent="#accordion" >
                ...
                <li class="@if(request()->is('admin/attribute/*/manage') && request()->input('type')=='subchildcategory') active @endif">
                    <a href="{{ route('admin-subchildcat-index') }}"><span>{{ __('Sub Child Category') }}</span></a>
                </li>
        </ul>
    </li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="general" data-parent="#accordion">
            ...
            <li>
                <a href="{{route('admin-page-index')}}"><span>{{ __('Page Settings') }}</span></a>
            </li>
            <li>
                <a href="{{route('admin-tax-settings')}}"><span>{{ __('Tax Settings') }}</span></a>
            </li>
             <!-- <li>
           ...
           <li>           
                <a href="{{ route('admin-ps-contact') }}"><span>{{ __('Contact Page') }}</span></a>
            </li>
            <li>           
                <a href="{{ route('admin-cms-index') }}"><span>{{ __('CMS') }}</span></a>
            </li>
    ...
    <li>
        <a href="{{ route('admin-sales-index') }}" class=" wave-effect"><i class="fa fa-dollar-sign"></i>{{ __('Sales') }}</a>
    </li>
    <li>
        <a href="{{ route('admin-subs-index') }}" class=" wave-effect"><i class="fas fa-users"></i>{{ __('Subscribers') }}</a>
    </li>
    <li>
