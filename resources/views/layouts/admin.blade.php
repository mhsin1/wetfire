...
<head>
    	...
    	<meta name="author" content="Organic Care Shop">
					...
					<div class="container-fluid">
						<div class="d-flex justify-content-between">
							<a class="admin-logo" href="{{ route('front.index') }}" target="_blank">
								<img src="{{asset('public/assets/front/images/logo/logo.png')}}" alt="">
							</a>
								...
								<ul class="list">
									...
									<li class="login-profile-area">
										<a class="dropdown-toggle-1" href="javascript:;">
											<div class="user-img">
												<img src="{{ Auth::guard('admin')->user()->photo ? asset('public/assets/images/admins/'.Auth::guard('admin')->user()->photo ):asset('public/assets/images/noimage.png') }}" alt="">
											</div>
										</a>
										<div class="dropdown-menu">
