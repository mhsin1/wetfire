...
<head>
		...
		<!-- favicon -->
		<link rel="icon"  type="image/x-icon" href="{{asset('public/assets/front/img/logo.png')}}"/>
		<!-- Bootstrap -->
	...
	<body>
		<div class="page">
			<div class="page-main">
					...
					<div class="container-fluid">
						<div class="d-flex justify-content-between">
  						   <a class="admin-logo" href="{{ route('front.index') }}" target="_blank">
								<img src="{{asset('public/assets/front/img/logo.png')}}" alt="">
							</a>
              ...
              <img src="{{ Auth::user()->photo ? asset(Auth::user()->photo):asset('public/assets/images/noimage.png') }}" alt="">
              @else
              <img src="{{ Auth::user()->photo ? asset('public/assets/images/users/'.Auth::user()->photo ):asset('public/assets/images/noimage.png') }}" alt="">
              @endif
											</div>
										</a>
										<div class="dropdown-menu">
							<div class="dropdownmenu-wrapper">
									<ul>
										<h5>{{ $langg->lang431 }}</h5>
											...
											<li>
												<a href="{{ route('vendor-profile') }}"><i class="fas fa-shopping-cart"></i> Edit Shop Profile</a>
											</li>
											<li>
