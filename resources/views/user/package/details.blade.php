...
<div class="account-info">
                            ...
                            <form id="subscribe-form" enctype="multipart/form-data" class="pay-form" action="{{route('user-vendor-request-submit')}}" method="POST">
                            ...
                            @include('includes.admin.form-error') 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <select name="country" class="option" id="">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-lg-8">
                                                    <input type="file" name="shop_logo" class="option" >
                                            </div>
                                        </div>
