...
Route::get('selectCountry', 'Front\FrontendController@selectCountry')->name('front.selectCountry');
Route::get('selectState/{id}', 'Front\FrontendController@selectState')->name('front.selectState');
Route::get('selectCity/{id}', 'Front\FrontendController@selectCity')->name('front.selectCity');
  // ************************************ ADMIN SECTION **********************************************
...
Route::prefix('admin')->group(function() {
  ...
  Route::get('/order/assign/{id}', 'Admin\OrderController@assign')->name('admin-order-assign');
  Route::post('/order/assign_update', 'Admin\OrderController@assign_update')->name('admin-order-assign-update');
  ...
  Route::get('/products/allDelete', 'Admin\ProductController@allDelete')->name('admin-prod-alldelete');
  ...
  // ADMIN SALES
  Route::get('/ajaxSales/{year}/{month}','Admin\SalesController@getSales');
  Route::get('/sales' , 'Admin\SalesController@index')->name('admin-sales-index');
  // ADMIN SALES
...
// Verification Section Ends
  ...
  Route::get('/attribute/{subchildcatid}/attrCreateForSubchildcategory', 'Admin\AttributeController@attrCreateForSubchildcategory')->name('admin-attr-createForSubchildcategory');
  ...
  Route::get('/subchildcategory/datatables', 'Admin\SubchildCategoryController@datatables')->name('admin-subchildcat-datatables'); //JSON REQUEST
  Route::get('/subchildcategory', 'Admin\SubchildCategoryController@index')->name('admin-subchildcat-index');
  Route::get('/subchildcategory/create', 'Admin\SubchildCategoryController@create')->name('admin-subchildcat-create');
  Route::post('/subchildcategory/create', 'Admin\SubchildCategoryController@store')->name('admin-subchildcat-store');
  Route::get('/subchildcategory/edit/{id}', 'Admin\SubchildCategoryController@edit')->name('admin-subchildcat-edit');
  Route::post('/subchildcategory/edit/{id}', 'Admin\SubchildCategoryController@update')->name('admin-subchildcat-update');
  Route::get('/subchildcategory/delete/{id}', 'Admin\SubchildCategoryController@destroy')->name('admin-subchildcat-delete');
  Route::get('/subchildcategory/status/{id1}/{id2}', 'Admin\SubchildCategoryController@status')->name('admin-subchildcat-status');
  Route::get('/load/subchildcategories/{id}/', 'Admin\SubchildCategoryController@load')->name('admin-subchildcat-load'); //JSON REQUEST

  // SUBCHILDCATEGORY SECTION ENDS------------
  ...
  //------------ ADMIN PRODUCT DISCUSSION SECTION ------------
    ...
    Route::get('/cms', 'Admin\GeneralSettingController@cms')->name('admin-cms-index');
    Route::post('/cms-update', 'Admin\GeneralSettingController@cms_update')->name('admin-cms-update');
    });
 ...
 //------------ ADMIN PRODUCT DISCUSSION SECTION ENDS ------------
  ...
  Route::get('/offer/type', 'Admin\OfferController@type')->name('admin-offer-type');
  Route::get('/offer/create', 'Admin\OfferController@create')->name('admin-offer-create');

  Route::get('/offer/create/1', 'Admin\OfferController@create_type_1')->name('admin-offer-create-1');
  Route::get('/offer/create/2', 'Admin\OfferController@create_type_2')->name('admin-offer-create-2');
  Route::get('/offer/create/3', 'Admin\OfferController@create_type_3')->name('admin-offer-create-3');
  ...
  Route::post('/offer/edit/{id}', 'Admin\OfferController@update')->name('admin-offer-update');
  Route::get('/offer/delete/{id}', 'Admin\OfferController@destroy')->name('admin-offer-delete');
  Route::get('/offer/status/{id1}/{id2}', 'Admin\OfferController@status')->name('admin-offer-status');
  Route::get('/offer/feature/{id1}/{id2}', 'Admin\OfferController@feature')->name('admin-offer-feature');
  ...
  Route::get('/return_order/datatables', 'Admin\ReturnOrderController@datatables')->name('admin-return_order-datatables');
  Route::get('/return_orders', 'Admin\ReturnOrderController@index')->name('admin-return_order-index');
  Route::get('/return_order/{id}', 'Admin\ReturnOrderController@show')->name('admin-return_order-show');
  Route::get('/return_order/{id}/delete', 'Admin\ReturnOrderController@delete')->name('admin-return_order-delete');
  Route::get('/return_order/response/{value}', 'Admin\ReturnOrderController@reason_response')->name('admin-return_order-reason');
  
  Route::get('/reason/datatables', 'Admin\ReasonController@datatables')->name('admin-reason-datatables'); //JSON REQUEST
  Route::get('/reason', 'Admin\ReasonController@index')->name('admin-reason-index');
  Route::get('/reason/create', 'Admin\ReasonController@create')->name('admin-reason-create');
  Route::post('/reason/create', 'Admin\ReasonController@store')->name('admin-reason-store');
  Route::get('/reason/edit/{id}', 'Admin\ReasonController@edit')->name('admin-reason-edit');
  Route::post('/reason/edit/{id}', 'Admin\ReasonController@update')->name('admin-reason-update');
  Route::get('/reason/delete/{id}', 'Admin\ReasonController@destroy')->name('admin-reason-delete');
  Route::get('/reason/status/{id1}/{id2}', 'Admin\ReasonController@status')->name('admin-reason-status');
...
// ------------ GLOBAL ----------------------
  ...
  Route::get('/general-settings/update/tax', 'Admin\GeneralSettingController@tax')->name('admin-tax-settings');
  Route::post('/general-settings/update/tax', 'Admin\GeneralSettingController@taxUpdate')->name('admin-tax-update');
...
Route::prefix('user')->group(function() {
  ...
  Route::get('/verify-page', 'User\RegisterController@get_verify_page')->name("verify_page");
  Route::post('/verify', 'User\RegisterController@verifyCode')->name("verify-account");
...
// User Orders
  ...
  Route::get('order/return/{id}', 'User\OrderController@orderReturn')->name('order.return');
  Route::post('order/return/submit', 'User\OrderController@order_return_submit')->name('order-return-submit');
...
//   Route::post('/paypal/cardstream', 'User\CardstreamController@store')->name('user.cardstream.submit');
...
Route::prefix('vendor')->group(function() {
  ...
  Route::get('/orders/{type}', 'Vendor\OrderController@type')->name('vendor-order-type');
...
// ************************************ FRONT SECTION **********************************************
  ...
  Route::get('/country/{id}', 'Front\FrontendController@country')->name('front.country');
  Route::get('/state/{id}', 'Front\FrontendController@state')->name('front.state');
  Route::get('/city/{id}', 'Front\FrontendController@city')->name('front.city');
  Route::get('/language/{id}', 'Front\FrontendController@language')->name('front.language');

  // User Contact
  Route::get('/contact', 'Front\FrontendController@showContactForm')->name('contact');
  Route::get('/faq', 'Front\FrontendController@showFaq')->name('faq');
  Route::get('/category_electric', 'Front\FrontendController@category_electric')->name('category_electric');
  // User Contact End
  ...
  Route::get('/offer/quick/view/{id}/','Front\CatalogController@offer_quick')->name('offer.quick');  
  ...
  Route::get('/addoffer/{id}','Front\CartController@addoffer')->name('product.offer.cart.add');
  ...
  Route::get('/offerremovecart/{id}','Front\CartController@offerremovecart')->name('offer.cart.remove');
  Route::get('/carts/coupon','Front\CartController@coupon');
  Route::get('/carts/coupon/check','Front\CartController@couponcheck');
  // CART SECTION ENDS

  // CHECKOUT SECTION
  Route::get('/checkout/','Front\CheckoutController@checkout')->name('front.checkout')->middleware(['auth']);;
  ...
  Route::post('/checkout/payment/return-card-payment', 'Front\PaymentController@payreturncardpayment')->name('payment.card');
  ...
  Route::post('/paytabs-submit', 'Front\PaymentController@paytabs')->name('paytabs.submit');

  Route::post('paytabs_response','Front\PaymentController@paytabsResponse')->name('paytabs_response');
  Route::post('paytabs_cancel','Front\PaymentController@paytabsCancel')->name('paytabs_cancel');
